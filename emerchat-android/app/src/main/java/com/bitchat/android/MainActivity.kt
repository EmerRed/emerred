...
class MainActivity : OrientationAwareActivity() {
    ...
    /**
     * Full-screen emergency alert shown when the server fires the remote
     * alarm (see TelemetryAlarmManager). Dismissing silences sound and
     * vibration but telemetry keeps reporting.
     */
    @Composable
    private fun TelemetryAlarmOverlay() {
        val alarmActive by com.bitchat.android.services.TelemetryAlarmManager.alarmActive.collectAsState()
        ...
        androidx.compose.material3.Surface(
            ...
            androidx.compose.foundation.layout.Column(
                ...
                androidx.compose.material3.Text(
                    text = androidx.compose.ui.res.stringResource(com.bitchat.android.R.string.alarm_title),
                ...
                androidx.compose.material3.Text(
                    text = androidx.compose.ui.res.stringResource(com.bitchat.android.R.string.alarm_overlay_body),
                ...
                androidx.compose.material3.Button(
                    onClick = { com.bitchat.android.services.TelemetryAlarmManager.dismiss(context) },
                    colors = androidx.compose.material3.ButtonDefaults.buttonColors(
                        containerColor = androidx.compose.ui.graphics.Color.White,
                        contentColor = androidx.compose.ui.graphics.Color(0xFFB00020)
                    )
                ) {
                    androidx.compose.material3.Text(
                        text = androidx.compose.ui.res.stringResource(com.bitchat.android.R.string.alarm_dismiss)
                    )
                }
            }
        }
